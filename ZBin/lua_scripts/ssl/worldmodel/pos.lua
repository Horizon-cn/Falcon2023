...
function supportLeftPos2022()
	local supportPos = supportPos2022:getSupportPos(vision):getLeftSupportPos()
	return supportPos
end

function supportRightPos2022()
	local supportPos = supportPos2022:getSupportPos(vision):getRightSupportPos()
	return supportPos
end
...
function rightCenterBackPos()
	return defPos2015:getDefPos2015(vision):getRightCenPos()
end
...
function defendMiddleHeadPos()
	return DefendUtils.getMiddleAreaPos()
end

function defendDribblePos()
	return DefendUtils.getDeDribblePos()
end
