...
["start"] = {
  ...
  Leader   = task.staticGetBall(CHIP_POS),
  Assister = task.goCmuRush(ASSISTER_POS_1,_,_,flag.allow_dss),
  Special  = task.goCmuRush(SPECIAL_POS_1,_,_,flag.allow_dss),
  Middle   = task.goCmuRush(MIDDLE_POS_1,_,_,flag.allow_dss),
  Defender = task.singleBack(),
  Goalie   = task.goalieNew(),
  Engine   = task.goCmuRush(ENGINE_POS_1,_,_,flag.allow_dss),
  Hawk     = task.goCmuRush(HAWK_POS_1,_,_,flag.allow_dss),
  match    = "{LASMDEH}"
},
...
["temp"] = {
  ...
  Assister = task.goCmuRush(ASSISTER_POS_1,_,_,flag.allow_dss),
  Special  = task.goCmuRush(SPECIAL_POS_1,_,_,flag.allow_dss),
  Middle   = task.goSpeciPos(MIDDLE_POS_1,_,flag.allow_dss),
  Defender = task.singleBack(),
  Goalie   = task.goalieNew(),
  Engine   = task.goCmuRush(ENGINE_POS_1,_,_,flag.allow_dss),
  Hawk     = task.goCmuRush(HAWK_POS_1,_,_,flag.allow_dss),
...
["chip"] = {
  ...
  Hawk     = task.goCmuRush(HAWK_POS_2,_,_,flag.allow_dss),
  match    = "{LASMDEH}"
},
...
["receive"] = {
  ...
  Leader   = task.goCmuRush(CGeoPoint:new_local(200,20),_,_,flag.allow_dss),
  Special  = task.goCmuRush(SPECIAL_POS_2,_,_,flag.allow_dss),
  Middle   = task.defendMiddle(),
  Defender = task.rightBack(),
  Assister = task.receiveShoot(),
  Goalie   = task.goalieNew(),
