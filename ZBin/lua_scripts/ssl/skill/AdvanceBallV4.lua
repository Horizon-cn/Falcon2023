function AdvanceBallV4(task)
	...
	execute = function(runner)
		...
		return CAdvanceBallV4(runner, mflag, tandemNum)  --return CAdvanceBall(runner, mflag, tandemNum)-- return CAdvanceBallOld(runner, mflag)
