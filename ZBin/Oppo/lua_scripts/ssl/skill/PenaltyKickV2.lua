function PenaltyKickV2(task)
	...
	execute = function(runner)
		...
		return CPenaltyKickV2(runner, mflag, tandemNum)  --return CAdvanceBall(runner, mflag, tandemNum)-- return CAdvanceBallOld(runner, mflag)
