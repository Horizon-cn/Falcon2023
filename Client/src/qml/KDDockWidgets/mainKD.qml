...
//              }
        ...
        Component.onCompleted: {
            ...
            // Add dock2 to the left of dock1
            addDockWidget(dock2, KDDW.KDDockWidgets.Location_OnRight, dock1, Qt.size(roots.width - roots.height*4/3, roots.height));
            addDockWidget(dock3, KDDW.KDDockWidgets.Location_OnBottom, dock2);
