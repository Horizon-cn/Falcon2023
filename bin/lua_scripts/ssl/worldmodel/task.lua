...
function support(role, num)
	local mexe, mpos = GoCmuRush{ pos = ball.supportPassPos(num), dir = player.toShootOrRobot(role),sender=role,flag=bit:_or(flag.allow_dss, flag.dodge_ball),srole="support"..num}
	return {mexe, mpos}
end
