...
gTestPlay = function ()
	if not IS_YELLOW then
		return "Test_Run6" --"Test_AdvanceV4"  --"NormalPlayPureDefence" --"Test_Run6" --"Test_play6" --"Test_Run"
		-- Test_Run6 测testrun
		-- Test_play6ForTest测三车进攻
	else
		return "Test_Run6" --"Test_Defence" --"Test_PassEachOther" --"Test_NormalMiddleDefend"
	end
