...
CAdvanceBallV3::CAdvanceBallV3() {
	...
	READ_PARAM(OPP_HAS_BALL_DIST)
		...
		READ_PARAM(ADV_FPASSPOWER)
		READ_PARAM(ADV_CPASSPOWER)
		READ_PARAM(TEND_TO_SHOOT_FLAG)
		READ_PARAM(SHOOT_BLOCKED_RANGE)
		READ_PARAM(PASS_BLOCKED_RANGE)
