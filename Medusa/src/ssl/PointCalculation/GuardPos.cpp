...
namespace {
	...
	// 后卫的运动范围
	CGeoPoint PENALTY_RIGHT_UP(-Param::Field::PITCH_LENGTH / 2 + queryParamByName("data\\ssl\\params\\params.xml", "PENALTY_AREA_DEPTH") + MIN_DIST_TO_PENALTY, -(Param::Field::PENALTY_AREA_WIDTH / 2 + MIN_DIST_TO_PENALTY));
	CGeoPoint PENALTY_RIGHT_DOWN(-Param::Field::PITCH_LENGTH / 2 + queryParamByName("data\\ssl\\params\\params.xml", "PENALTY_AREA_DEPTH") + MIN_DIST_TO_PENALTY, Param::Field::PENALTY_AREA_WIDTH / 2 + MIN_DIST_TO_PENALTY);
	...
	// 防守目标关键点
	CGeoPoint LEFTBACK_CRITICAL_POINT = CGeoPoint(-(Param::Field::PITCH_LENGTH / 2 - queryParamByName("data\\ssl\\params\\params.xml", "PENALTY_AREA_DEPTH") - Param::Vehicle::V2::PLAYER_SIZE), -Param::Field::PITCH_WIDTH / 2);
	CGeoPoint RIGHTBACK_CRITICAL_POINT = CGeoPoint(-(Param::Field::PITCH_LENGTH / 2 - queryParamByName("data\\ssl\\params\\params.xml", "PENALTY_AREA_DEPTH") - Param::Vehicle::V2::PLAYER_SIZE), Param::Field::PITCH_WIDTH / 2);
