...
{
	//本算法的初始化
    _DeDribblePos = CGeoPoint(-Param::Field::PITCH_LENGTH / 2 + Param::Field::PENALTY_AREA_DEPTH + 20, 0);
    _lastDeDribblePos = CGeoPoint(-Param::Field::PITCH_LENGTH / 2 + Param::Field::PENALTY_AREA_DEPTH + 20, 0);
