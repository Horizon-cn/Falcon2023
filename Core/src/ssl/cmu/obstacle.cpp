...
#include <utils.h>
#include <geometry.h>
#include "PathPlan/PredictTrajectory.h"
...
void obstacles::addObs(const CVisionModule *pVision, const TaskT &task, bool drawObs, double oppAvoidDist, double teammateAvoidDist, double ballAvoidDist) {//CAN add Penalty area depth as interface
	...
	else if (!(flags & PlayerStatus::NOT_DODGE_PENALTY))
