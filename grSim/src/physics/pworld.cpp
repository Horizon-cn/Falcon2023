...
{   
    ...
    if (j!=-1)
    {
        ...
        if (n > 0) {
          ...
          //std::cout << "Pos" << sur->contactPos[0] << sur->contactPos[1] << sur->contactPos[2] << std::endl;
          //std::cout << "Normal" << sur->contactNormal[0] << sur->contactNormal[1] << sur->contactNormal[2] << std::endl;
          bool flag=true;
