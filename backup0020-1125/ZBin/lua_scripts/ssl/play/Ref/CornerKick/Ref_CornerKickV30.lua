...
local REAL_SHOOT_POS = CGeoPoint:new_local(355, 125)
...
local TMP_DEFENDER_POS = {
  ball.refAntiYPos(CGeoPoint:new_local(260, 150)),
...
gPlayTable.CreatePlay{
  ...
  ["runTmpPos"] = {
    switch = function ()
      if bufcnt(player.toPointDist("Defender", TMP_LEADER_POS[1]()) < 20 ,3,120)then
        return "passBall"
      end
    end,
